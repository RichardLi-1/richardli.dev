  ...
  return (
    <AnimatedPage>
      <div className="min-h-screen page-bg">
        ...
        <main className="antialiased max-w-3xl mx-auto p-6 [&_p]:text-[var(--text-2)]" style={{ paddingTop: isMobile ? "0px" : "60px" }}>
          <StaggeredContent delay={0}>
            <div className="text-left mb-4">
              <h1 className="text-3xl font-bold mb-2">SalesPatriot (YC W25)</h1>
              <h1 className="text-m text-[var(--text-2)]">Work, 2025</h1>
            </div>
          </StaggeredContent>

          <StaggeredContent delay={100}>
            {/* Hero Image */}
            <div className="relative mb-8 aspect-video w-full bg-[var(--surface)] overflow-hidden" style={{cornerShape:"squircle", borderRadius:16}}>
              <img
          ...
          <StaggeredContent delay={300}>
            <CollapsibleDetails labels={["Timeline", "Team", "Tools", "Overview"]} animateContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="space-y-6">
                <motion.div variants={itemVariants}>
                  <p className="section-label mb-2">Timeline</p>
                  <p className="text-[var(--text-2)]">2 months, 2025</p>
                </motion.div>
...
*/}
          ...
          <StaggeredContent delay={500}>
            <section className="space-y-6 mb-12">
              <h2 className="text-2xl font-bold mb-4">Example Work</h2>
              <div className="relative mb-8 aspect-video w-full bg-[var(--surface)] overflow-hidden rounded-lg border border-[var(--border-2)]" style={{cornerShape:"squircle", borderRadius:16}}>
                <img
